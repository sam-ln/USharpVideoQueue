...
namespace ClientSimTest.Examples
{
    public class ClientSimWorldTestExampleScene : ClientSimWorldTestBase
    {
        ...
        private static readonly string _sceneName = "VideoPlayerQueueExampleScene";
        private static readonly string _samplesDirectory = Path.Combine("Assets", "USharpVideoQueue", "Examples", "Scenes");
        ...
        {
            Debug.Log("ClientSim startup commenced");
            yield return WaitForClientSimStartup();
            Debug.Log("ClientSim startup complete");
            yield return null;
